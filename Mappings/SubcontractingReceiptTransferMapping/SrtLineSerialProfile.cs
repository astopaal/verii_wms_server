...
{
    public class SrtLineSerialProfile : Profile
    {
        public SrtLineSerialProfile()
        {
            CreateMap<SrtLineSerial, SrtLineSerialDto>()
                ...
                .ApplyFullUserNames<SrtLineSerial, SrtLineSerialDto>();
            ...
            // CreateSrtLineSerialWithLineKeyDto to SrtLineSerial (for GenerateOrderAsync)
