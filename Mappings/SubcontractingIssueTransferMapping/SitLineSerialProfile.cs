...
{
    public class SitLineSerialProfile : Profile
    {
        public SitLineSerialProfile()
        {
            CreateMap<SitLineSerial, SitLineSerialDto>()
                ...
                .ApplyFullUserNames<SitLineSerial, SitLineSerialDto>();
            ...
            // CreateSitLineSerialWithLineKeyDto to SitLineSerial (for GenerateOrderAsync)
