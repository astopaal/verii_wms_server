...
{
    public class WtLineSerialProfile : Profile
    {
        public WtLineSerialProfile()
        {
            CreateMap<WtLineSerial, WtLineSerialDto>()
                ...
                .ApplyFullUserNames<WtLineSerial, WtLineSerialDto>();
            ...
            // CreateWtLineSerialWithLineKeyDto to WtLineSerial (for GenerateWarehouseTransferOrderAsync)
            ...
            // CreateWtLineSerialWithGuidDto to WtLineSerial (for BulkWtGenerateAsync)
            CreateMap<CreateWtLineSerialWithGuidDto, WtLineSerial>()
                .ForMember(dest => dest.LineId, opt => opt.Ignore())
                .ForMember(dest => dest.Quantity, opt => opt.MapFrom(src => src.Quantity))
                .ForMember(dest => dest.SerialNo, opt => opt.MapFrom(src => src.SerialNo))
                .ForMember(dest => dest.SerialNo2, opt => opt.MapFrom(src => src.SerialNo2))
