...
{
    public class ShLineProfile : Profile
    {
        public ShLineProfile()
        {
            CreateMap<ShLine, ShLineDto>()
                ...
                .ApplyFullUserNames<ShLine, ShLineDto>();
            ...
            // CreateShLineWithKeyDto to ShLine (for GenerateShipmentOrderAsync)
