...
{
    public class WoLineSerialProfile : Profile
    {
        public WoLineSerialProfile()
        {
            CreateMap<WoLineSerial, WoLineSerialDto>()
                ...
                .ApplyFullUserNames<WoLineSerial, WoLineSerialDto>();
            ...
            // CreateWoLineSerialWithLineKeyDto to WoLineSerial (for GenerateWarehouseOutboundOrderAsync)
