...
namespace WMS_WEBAPI.Controllers
{
    ...
    public class ShTerminalLineController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<ApiResponse<IEnumerable<ShTerminalLineDto>>>> GetAll()
        {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<ApiResponse<ShTerminalLineDto>>> GetById(long id)
        {
        ...
        public async Task<ActionResult<ApiResponse<IEnumerable<ShTerminalLineDto>>>> GetByHeaderId(long headerId)
        {
        ...
        [HttpGet("user/{userId}")]
        public async Task<ActionResult<ApiResponse<IEnumerable<ShTerminalLineDto>>>> GetByUserId(long userId)
        {
        ...
        [HttpPut("{id}")]
        public async Task<ActionResult<ApiResponse<ShTerminalLineDto>>> Update(long id, [FromBody] UpdateShTerminalLineDto updateDto)
        {
