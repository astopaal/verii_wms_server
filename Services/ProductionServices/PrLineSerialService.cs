    ...
    public class PrLineSerialService : IPrLineSerialService
    {
        ...
        public async Task<ApiResponse<bool>> SoftDeleteAsync(long id)
        {
            try
            {
                ...
                var remainingSerialCount = await _unitOfWork.PrLineSerials
                    .AsQueryable()
                ...
                if (remainingSerialCount == 0)
                {
                    ...
                    if (!hasImportLines)
                    {
                        ...
                        if (lineEntity != null)
                        {
                            ...
                            var remainingLinesUnderHeader = await _unitOfWork.PrLines
                                .AsQueryable()
                ...
                var msgKey = lineDeleted ? "PrLineSerialDeletedAndLineDeleted" : "PrLineSerialDeletedSuccessfully";
