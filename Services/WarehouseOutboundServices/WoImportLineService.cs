                ...
                using (var tx = await _unitOfWork.BeginTransactionAsync())
                {
                    try
                    {
                        ...
                        if (request.Quantity <= 0)
                        {
                            ...
                            return ApiResponse<WoImportLineDto>.ErrorResult(
                                _localizationService.GetLocalizedString("WoImportLineQuantityInvalid"), 
                                _localizationService.GetLocalizedString("WoImportLineQuantityInvalid"), 
                                400);
                        }
                        ...
                        if (header == null || header.IsDeleted)
                        {
                            await _unitOfWork.RollbackTransactionAsync();
                            return ApiResponse<WoImportLineDto>.ErrorResult(
                                _localizationService.GetLocalizedString("WoHeaderNotFound"), 
                                _localizationService.GetLocalizedString("WoHeaderNotFound"), 
                                404);
                        }
                        ...
                        var matchingLines = await _unitOfWork.WoLines
                            .AsQueryable()
                        ...
                        if (!matchingLines.Any())
                        {
                            await _unitOfWork.RollbackTransactionAsync();
                            return ApiResponse<WoImportLineDto>.ErrorResult(
                                _localizationService.GetLocalizedString("WoImportLineStokCodeAndYapCodeNotMatch"), 
                                _localizationService.GetLocalizedString("WoImportLineStokCodeAndYapCodeNotMatch"), 
                                404);
                        }
                        ...
                        var lineSerials = await _unitOfWork.WoLineSerials
                            .AsQueryable()
                        ...
                        // Get WoParameter for validation rules
...

                        {
                            ...
                            if (hasSerialInLineSerials && hasRequestSerial)
                            {
                                ...
                                if (!matchingLineSerials.Any())
                                {
                                    await _unitOfWork.RollbackTransactionAsync();
                                    return ApiResponse<WoImportLineDto>.ErrorResult(
                                        _localizationService.GetLocalizedString("WoImportLineSerialNotMatch"), 
                                        _localizationService.GetLocalizedString("WoImportLineSerialNotMatch"), 
                                        404);
                                }
                                ...
                                {
                                    await _unitOfWork.RollbackTransactionAsync();
                                    var localizedMessage = _localizationService.GetLocalizedString("WoHeaderQuantityCannotBeGreater", 
                                    ...
                                    return ApiResponse<WoImportLineDto>.ErrorResult(localizedMessage, exceptionMessage, 400);
                                }
                            }
                            // ============================================
                        ...
                        if (!selectedLineId.HasValue)
                        {
                            ...
                            foreach (var line in matchingLines)
                            {
                                ...
                                var routeTotal = await _unitOfWork.WoRoutes
                                    .AsQueryable()
                                    .Where(r => !r.IsDeleted
                        ...
                        if (!selectedLineId.HasValue)
                        {
                            await _unitOfWork.RollbackTransactionAsync();
                            return ApiResponse<WoImportLineDto>.ErrorResult(
                                _localizationService.GetLocalizedString("WoImportLineNoMatchingLine"), 
                                _localizationService.GetLocalizedString("WoImportLineNoMatchingLine"), 
                                400);
                        }

                        WoImportLine? importLine = await _unitOfWork.WoImportLines
                            .AsQueryable()
