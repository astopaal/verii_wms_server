...
namespace WMS_WEBAPI.Services
{
    public class SitHeaderService : ISitHeaderService
    {
        ...
        public async Task<ApiResponse<PagedResponse<SitHeaderDto>>> GetCompletedAwaitingErpApprovalPagedAsync(int pageNumber, int pageSize, string? sortBy = null, string? sortDirection = "asc")
        {
            try
            {
                if (pageNumber < 1) pageNumber = 1;
